        ...
        <div className="absolute bottom-12 left-0 right-0 flex justify-center">
          ...
          >
            <h3 className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">
              {timeline.currentYear} Casualties
            </h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm font-medium">
                  {new Intl.NumberFormat().format(Math.round(currentYearData.casualties.palestine || 0))}
                </p>
              </div>
              <div>
                <div className="flex items-center">
                ...
                <p className="text-sm font-medium">
                  {new Intl.NumberFormat().format(Math.round(currentYearData.casualties.israel || 0))}
                </p>
              </div>
            </div>
          </motion.div>
